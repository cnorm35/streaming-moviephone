module WatchmodeData
  ...
  def genres
    ...
    {"id"=>29, "name"=>"Sports", "tmdb_id"=>nil},
    {"id"=>37, "name"=>"Supernatural", "tmdb_id"=>nil},
    {"id"=>26, "name"=>"Talk", "tmdb_id"=>10767},
    {"id"=>17, "name"=>"Thriller", "tmdb_id"=>53},
    {"id"=>35, "name"=>"Travel", "tmdb_id"=>nil},
